...
public class TrackingScrollView(context: Context, attrs: AttributeSet) : ScrollView(context, attrs) {
    public trait OnScrollChangedListener {
        public fun onScrollChanged(source: TrackingScrollView, l: Int, t: Int, oldl: Int, oldt: Int)
    }
